...
const Section_2 = () => {
  ...
  return (
    <section id="about">
      <h1 className="px-6 font-normal text-3xl sm:text-6xl tracking-tight ">
      ...
      <div className="px-6 mt-12 flex gap-4 justify-center  flex-col md:flex-row">
        {values.map((value) => {
          return (
            <div
              className=" bg-[#121316] py-[70px] px-[60px] opacity-75
            ...
            >
              ...
              <p className=" text-xl font-medium text-[#BCBCBC] mt-5">
                {value.description}
              </p>
            </div>
          )
      ...
      <div className=" pl-4 ml-4 mt-32 text-xl sm:text-5xl font-normal   flex justify-center items-center h-20 bg-[#121316]">
        <p className="tracking-widest">
          UNLEASH YOUR <span className="text-[#55C106] "> ANDROID </span>{' '}
          AWESOMENESS
        </p>{' '}
      </div>
    </section>
