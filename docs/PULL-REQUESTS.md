...
```text
$ git clone git@github.com:username/AC-Website-NextJs.git
$ cd AC-Website-NextJs
$ git remote add upstream https://github.com/Android-Club-VITC/AC-Website-NextJs.git
$ git fetch upstream
```
...
Fixes: https://github.com/Android-Club-VITC/AC-Website-NextJs/issues/1337
